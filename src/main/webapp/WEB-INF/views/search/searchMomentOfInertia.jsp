...
<html>
	<head>
		<title>Search by moment of inertia</title>
		<meta charset="UTF-8" />
...
<div class="header">
			...
			<div class="content">
				<div class="wrapper">
					...
					<c:url var="addAction" value="/search-planeMomentOfInertia" ></c:url>
					<form:form action="${addAction}" commandName="plane"  class="box search" >
						<fieldset class="boxBody">
								  <label><strong>Search by momemt of inertia:</strong></label>					  
						</fieldset>
						<footer>
						  ...
						  <div class="box">
							  <div class="container-1">
								  ...
								  <form:input path="momentOfInertia" type="text" id="search"  placeholder="Enter momemt..." />
							  </div>
							</div>
						</footer>
