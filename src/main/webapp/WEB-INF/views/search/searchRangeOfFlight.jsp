...
<html>
	<head>
		<title>Search by range of flight</title>
		<meta charset="UTF-8" />
...
<div class="header">
			...
			<div class="content">
				<div class="wrapper">
					<c:url var="addAction" value="/search-planeRangeOfFlight" ></c:url>
					<form:form action="${addAction}" commandName="plane"  class="box search" >
					
						<fieldset class="boxBody">
								  <label><strong>Search by range of flight:</strong></label>					  
						</fieldset>
						<footer>
						  ...
						  <div class="box">
							  <div class="container-1">
								  ...
								  <form:input path="rangeOfFlight" type="text" id="search"  placeholder="Enter range..." />
							  </div>
							</div>
						</footer>
