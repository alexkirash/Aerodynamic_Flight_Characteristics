...
<html>
	<head>
		<title>Search by drag force</title>
		<meta charset="UTF-8" />
...
<div class="header">
			...
			<div class="content">
				<div class="wrapper">
					...
					<c:url var="addAction" value="/search-planeDragForce" ></c:url>
					<form:form action="${addAction}" commandName="plane"  class="box search" >
					
						<fieldset class="boxBody">
								  <label><strong>Search by drag force:</strong></label>					  
						</fieldset>
						<footer>
						  ...
						  <div class="box">
							  <div class="container-1">
								  ...
								  <form:input path="dragForce" type="text" id="search"  placeholder="Enter drag force..." />
							  </div>
							</div>
						</footer>
