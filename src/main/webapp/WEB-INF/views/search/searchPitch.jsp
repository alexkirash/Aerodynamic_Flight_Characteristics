...
<div class="header">
			...
			<div class="content">
				<div class="wrapper">
					<c:url var="addAction" value="/search-planePitch" ></c:url>
					<form:form action="${addAction}" commandName="plane"  class="box search" >
					
						<fieldset class="boxBody">
								  <label><strong>Search by pitch:</strong></label>					  
						</fieldset>
						<footer>
						  ...
						  <div class="box">
							  <div class="container-1">
								  <span class="icon"><i class="fa fa-search"></i></span>
								   <form:input path="pitch" type="text" id="search"  placeholder="Enter pitch..." />
							  </div>
							</div>
						</footer>
